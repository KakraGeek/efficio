...
exports.payments = exports.inventory = exports.orders = exports.clients = void 0;
...
exports.orders = (0, pg_core_1.pgTable)("orders", {
    id: (0, pg_core_1.serial)("id").primaryKey(),
    user_id: (0, pg_core_1.text)("user_id").notNull(), // Clerk user ID for access control
    client_id: (0, pg_core_1.integer)("client_id").notNull().references(function () { return exports.clients.id; }),
...
exports.payments = (0, pg_core_1.pgTable)("payments", {
    id: (0, pg_core_1.serial)("id").primaryKey(),
    user_id: (0, pg_core_1.text)("user_id").notNull(), // Clerk user ID for access control
    order_id: (0, pg_core_1.integer)("order_id").notNull().references(function () { return exports.orders.id; }),
