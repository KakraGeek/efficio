  ...
  return (
    <div className="min-h-screen w-screen flex flex-col items-center justify-center bg-gray-50 p-4">
      ...
      <div className="hidden lg:flex flex-row gap-4 w-full max-w-5xl justify-center mb-8">
        {features.map((f, i) => (
          <div key={i} className="bg-white rounded-xl shadow p-4 flex flex-col items-center border border-gray-100 min-h-[140px] w-48">
            {f.icon}
      ...
      <div className="w-full max-w-md flex flex-col items-center justify-center z-10 bg-white rounded-xl shadow-lg p-8 border border-gray-100">
        <h1 className="text-3xl font-bold text-blue-700 mb-4 text-center">Welcome to Efficio</h1>
        <p className="text-gray-600 mb-6 text-center">Business management for Ghanaian fashion artisans. Effortlessly manage clients, orders, payments, inventory, and view reports—all in one place.</p>
